...
FT_01_WD=
FT_02_LB=
FT_02_CM=python -m py_compile "%f"
FT_02_WD=
EX_00_LB=Execute
EX_00_CM=clear; chmod a+rwx %f;  python3 %f; rm -rf __pycache__ .DS_Store
EX_00_WD=
error_regex=([^:]+):([0-9]+):([0-9:]+)? .*
EX_01_LB=python2
EX_01_CM=clear; chmod a+rwx %f;  python2.7 %f; rm -rf __pycache__ .DS_Store
EX_01_WD=
...
EX_02_WD=
FT_00_LB=_Compile
FT_00_CM=/usr/bin/python %f
FT_00_WD=
EX_03_LB=2to3
EX_03_CM=clear; 2to3 -w %f
EX_03_WD=
