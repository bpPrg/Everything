...
:Runtime: 2 mins for 30 * 4 original files (4 different redshifts.)
"""
# Imports
import subprocess
import time
...
def fitted_Pgamma(z):
    ...
    :Inputs: Inputs are galshear_cut.cat and following Pgamma par files:
        1. galshear_mpg0.par
    ...
    :Commands: gen2Dpolymode, lc +all 'x= ox' > galshear_fpg.cat etc.
